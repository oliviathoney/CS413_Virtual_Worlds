...
TPFuncShared("z",					function(v,t){t.z=v;}); TGMS_HIDE_WARNING z;
...
// Property Modifiers
//============================
function TPCeil(property)			{ return {data:[TPCeil, property]}; }
function TPFloor(property)			{ return {data:[TPFloor, property]}; }
function TPRound(property)			{ return {data:[TPRound, property]}; }
function TPShake(property, amount)	{ return {data:[TPShake, property, amount]}; }
function TPSnap(property, snap)		{ return {data:[TPSnap, property, snap]}; }
...
function TPCol(property)		{ return {data:[TPCol, property]}; }
function TPPath(path, absolute) { return {data:[TPPath, path, absolute]}; }
function TPPathExt(path, x, y)	{ return {data:[TPPath, path, x, y]}; } TGMS_HIDE_WARNING TPPathExt;
