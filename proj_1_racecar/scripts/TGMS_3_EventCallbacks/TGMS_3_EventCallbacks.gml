...
{	/// @func TweenAddCallback(tween, event, target, func|user, *arg0, *arg1);
	...
	*/
	...
	if (is_string(event)) 
	{ 
		event = TGMS_StringStrip(event, 0);
...
TGMS_HIDE_WARNING TweenCallbackEnable;
...
TGMS_HIDE_WARNING  TweenCallbackInvalidate;
...
TGMS_HIDE_WARNING TweenCallbackIsEnabled;
...
TGMS_HIDE_WARNING TweenCallbackIsValid;
...
TGMS_HIDE_WARNING TweenEventIsEnabled;
